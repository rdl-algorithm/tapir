...
class UnderwaterNavModifModel: public Model {
  public:
    ...
    double getHeuristicExploreCoefficient() {
        return heuristicExploreCoefficient;
    }
    long getMaxNnComparisons() {
        return maxNnComparisons;
    }
    double getMaxNnDistance() {
        return maxNnDistance;
    }
  ...
  private:
    ...
    double heuristicExploreCoefficient;
