#include "Nav2DSpcHistoryCorrector.hpp"


namespace nav2d {

Nav2DSpcHistoryCorrector::Nav2DSpcHistoryCorrector(Model *model) : HistoryCorrector(nullptr, model) {}

void Nav2DSpcHistoryCorrector::reviseSequence(HistorySequence *sequence) {
