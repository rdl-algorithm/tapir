...
$(TGTS_$(n)_$(1)): $(_BIN_$(n)_$(1)): $(_O_$(n)_$(1)) $(OBJS_NTGT_$(n)_$(1)) $(OBJS_solver_$(1)) $(OBJS_global_$(1)) $(OBJS_indexing_$(1)) $(OBJS_mappings_$(1)) $(OBJS_serialization_$(1)) $(OBJS_geometry_$(1))
	$$(LINK_RECIPE_$(1))
